...
export function InteractionsChartCard({
  ...
  return (
    <div className="">
      <span className="text-base text-general-secondary-foreground font-mono">
        {title}
      </span>

      <div className="flex items-center gap-4 mt-1.5 mb-1">
        <div className="rounded-lg bg-foreground-light p-2">
          <div className="bg-white rounded-lg p-1 flex flex-col gap-1">
            <span className="text-sm text-general-muted-foreground">{legend.label}</span>
            <div className="flex items-center gap-2">
              <span className="text-base font-mono">{legend.value}</span>
